...
export default function Terms() {
  ...
  return (
    <div className="container">
      ...
      <p>OVERVIEW</p>
      <p>
        This website is operated by Snark Roastery. Throughout the site, the
        terms “we”, “us” and “our” refer to Snark Roastery. Snark Roastery
      ...
      <p>
        SECTION 1 - ONLINE STORE TERMS By agreeing to these Terms of Service,
      ...
      <p>
        ...
        thereof) without notice at any time. We shall not be liable to you or to
      ...
      <p>
        ...
        every effort to display as accurately as possible the colors and images
      ...
      <p>
        SECTION 7 - OPTIONAL TOOLS We may provide you with access to third-party
      ...
      <p>
        SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS If, at our
      ...
      <p>
        ...
        shall Snark Roastery, our directors, officers, employees, affiliates,
      ...
      <p>
        ...
        harmless Snark Roastery and our parent, subsidiaries, affiliates,
      ...
      <p>
        ...
        construed in accordance with the laws of 480C McCartney St. Arnprior
        Ontario CA K7S 0B6.
      </p>
      <p>
        ...
        these Terms of Service by posting updates and changes to our website. It
        is your responsibility to check our website periodically for changes.
